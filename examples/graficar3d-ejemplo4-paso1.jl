...
#
# Uso:
#  julia examples/graficar3d-ejemplo4-paso1.jl
#  Genera `examples/graficar3d-ejemplo4-paso1.png` de alta resolución.
################################################################################
...
ax = Axis3(fig[1, 1];
    ...
    perspectiveness = 0.5,
    limits = (nothing, nothing, (-30, 8)))  # Fijar límites de z entre -30 y 8
...
# save("examples/graficar3d-ejemplo4-paso2.pdf", fig)
# save("examples/graficar3d-ejemplo4-paso2.svg", fig)